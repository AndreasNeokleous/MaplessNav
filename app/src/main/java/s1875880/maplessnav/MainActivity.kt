...
class MainActivity : AppCompatActivity(), GoogleApiClient.ConnectionCallbacks,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLongitudeText  = findViewById<View>(R.id.longTextView2) as TextView
        mLatitudeText = findViewById<View>(R.id.latTextView2) as TextView;
        val locBTN = findViewById<View>(R.id.button) as Button;
        locBTN.setOnClickListener {
            getLastLocation()
        }

        val mapboxBtn = findViewById<View>(R.id.mapboxbtn) as Button
        mapboxBtn.setOnClickListener {
